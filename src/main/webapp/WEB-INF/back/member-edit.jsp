...
<article class="page-container">
	<form action="/admin/user/update.jhtml" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  class="input-text"  value="${user.biological}" name="biological" id="biological">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>naturally Age：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  class="input-text"  value="${user.naturally}" name="naturally" id="naturally">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">Schedule status</label>
