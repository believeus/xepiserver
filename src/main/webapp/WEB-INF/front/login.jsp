            ...
            text-align: left;">
                <div id="CodeSignIn" style="display:none">
                    <div class="userName" style="display:flex">
                        <input type="text" name="username1" id="username1" style="width:92%" placeholder="Telephone"
                        ...
                        <button
                                ...
                                onclick="time(this)">SMS
                        </button>
                    </div>
                    <div class="passWord">
                        <lable style="color:#808080">&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/images/InOrUp/scode.png"
                    ...
                    <div style="padding:3% 0 3% 3%;height: 50px;">
                        ...
                        <div onclick="flash()"
                             style="float:left;width: 20%;height: 100%;border:1px solid #000;color:#abb8fc;border:1px solid #abb8fc; border-radius: 7px;text-align: center;line-height: auto">
                            Refresh
                        </div>
                    </div>
                    ...
                    <div class="other_login" style="margin-top: 40px;">
                            ...
                            <span> By clicking the button below, I agree to <a href="concent/index.jhtml"><i> the User Agreement and Privacy Policy.</i></a></span>
                ...
                <div id="PWDSignIn" style="display:block">
                    ...
                    <div class="passWord">
                        <lable style="color:#808080">&nbsp;&nbsp;&nbsp;&nbsp;<img src="static/images/InOrUp/pwd.png"
                                                                                  style="width: 16px;height: 16px;">&nbsp;&nbsp;&nbsp;&nbsp;
                        </lable>
        ...
        if (pwd != null) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data)
                    if (data == "error") {
                        alert("Please enter your registered email address and password.")
                    } else {
                        window.location.href = 'index.jhtml';
                    }
                },
