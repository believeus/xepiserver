...
<div id="container" style="width: 90%;height: auto;margin: 0 auto;">
    <div style="width: 100%;height: auto;margin: 0 auto;overflow: hidden;">
        ...
        <div style="width: 100%;height: 40px;">
            <div style="width: 50%;height: 40px;margin: 0 auto;border-radius: 50px;background-color: #0071BC;color: #FFFFFF;line-height: 40px; font-family: arial;text-align: center; font-size: 16px;">HKG epitherapeutics Customer Data Consent</div>
        </div>
        <div style="width: 100%;height: 20px;"></div>
