...
<div style="width: 60%;height: auto;margin: 0 auto; background-color:#ffffff">
                    ...
                    $.post("/user/cart/unPayGoodslist.jhtml", function (data) {
                        data.forEach(function (v) {
                            var div = "<div style='clear: both' name='cart'>" +
                                "<div style='width:100%;display: flex;flex-direction: row;justify-content: center;float: left;overflow: hidden;'>" +
                                "<div style='width: 100%;float: left;height: 200px;'>" +
                                "   <div style='width:30%;height:auto;float: left;text-align: center'><image src=" + v.imgpath + " style='width:58%;height:auto'></image></div>" +
    ...
    <div style="clear:both;overflow:hidden;width:100%;height:60px;;bottom:0;border-top:1px solid #e0e0e0;background:#fff;padding-bottom: 60px;">
        ...
        <div style="width: 60%;background-color: #0071b1;height: 100%;text-align: center;color: #f4f6f8;float:right;">
            <div name="paypal" style="height:100%;font-size: 22px;line-height: 60px;cursor: pointer;font-weight: bold">Confirm & proceed to payment</div>
        </div>
    </div>
</div>
</body>
        ...
        $("div[name=paypal]").click(function () {
            $.post("/user/cart/unPayGoodslist.jhtml", function (msg) {
                if (msg.length != 0) {
                    ...
                    window.location.href = '/user/paypal/payment.jhtml?mobile=false';
                } else {
