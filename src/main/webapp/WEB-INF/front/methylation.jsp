	...
	<div id="diag"style="width: 100%;height: auto;">
		...
		<div style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div style="width: 100%;height: auto;font-family: arial;color: #666666;line-height: 24px;">
				...
				<p>	when DNA methylation happens at several important positions in genes it can silence the function of the gene.</p>
				<p>This is how the same gene can be expressed or silenced in different cells in our body.</p>
			</div>
			<div style="width: 100%;height: auto;"><img src="static/images/methy-1.png"style="width: 100%;height: auto;"/></div>
			<div style="width: 100%;height: 20px;"></div>
			<hr />
		</div>
	</div>
	<div id="methy"style="width: 100%;height: auto;">
		...
		<div style="width: 96%;height: auto;margin: 0 auto;">
			<div style="width: 100%;height: auto;">
				<p style="font-family: arial;font-size: 24px;font-weight: 700;color: #036EB8;"> DNA methylation; the genome software</p>
			...
			<div style="font-family: arial;font-size: 16px;color: #036EB8;" >
				These genomic Apps make sure that our body functions properly. Each tissue is properly programmed to ensure our health and well being. Each cell type has its unique combination of methylation marks and as a consequence a unique combination of genes that are active and silent.
			</div>
			<div style="width: 100%;height: auto;"><img src="static/images/methy-2.png"style="width: 100%;height: auto;"/></div>
	...
	<div id="tumor"style="width: 100%;height: auto;">
		<div style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div style="width: 100%;height: auto;font-family: arial;color: #6D6D6D;">
				Studies in by Jirtle and his colleagues in 2004 showed in a mouse model that maternal diet during pregnancy affects DNA methylation of her offspring and change their coat color and rish of obesity and other conditions.
			</div>
			<div style="width: 100%;height: 20px;"></div>
			<div style="font-family: arial;color: #666666;">
				Studies by Szyf and colleagues discovered that maternal care and behavior affects DNA methylation of her offspring and how they react to stress later in life. These studies launched the fields of behavioral epigenetics and epigenetic psychiatry.
			</div>
			<div style="width: 100%;height: 20px;"></div>
			<div style="font-family: arial;color: #666666;">
		...
		<div style="width: 96%;height: auto;margin: 0 auto;">
			<div style="width: 100%;height: auto;">
				...
				<div style="width: 100%;height: auto; ">
					...
					<div id='dot' style="color: #666666;font-family: arial;">	Studies suggest that different environmental changes can change or reverse DNA methylation events.</div>
					<div style="width: 100%;height: 20px;"></div>


					<div id="dot" style="color: #666666;font-family: arial;">Thus, the potential is there that we might be able to change DNA methylation by lifestyle changes.</div>
					<div style="width: 100%;height: 20px;"></div>

					<div id="dot" style="color: #666666;font-family: arial;">Our optimism about DNA methylation derives from the fact that DNA methylation in difference from genetics is reversible.</div>
					<div style="width: 100%;height: 20px;"></div>
			...
			<div style="width: 100%;height: auto;">
				...
				<div style="width: 100%;height: auto;">
					<div style="width: 96%;height: auto;margin: 0 auto;">
						...
						<div id="dot" style="width: 100%; height: auto; color: #666666;font-family: arial;">
							It was discovered that the level of methylation of certain genes in our DNA changes as we age.</div>
						<div style="width: 100%;height: 20px;"></div>

						<div id="dot" style="width: 100%;height: auto; color: #666666;font-family: arial;">
							By measuring methylation in these genes it is possible to determine our biological age</div>
						<div style="width: 100%;height: 20px;"></div>
						<div id="dot" style="width: 100%;height: auto; color: #666666;font-family: arial;">
							Our biological age is a better measure of our health and well being than chronological ageriments.
						</div>
						<div style="width: 100%;height: 20px;"></div>
						<div id="dot" style="width: 100%;height: auto; color: #666666;font-family: arial;">
