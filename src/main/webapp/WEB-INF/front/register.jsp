...
<div style="background-image:url('static/images/bg.png');width:100%;height:667px;">
    <div style="width: 90%;height: auto;margin: 0 auto;">
        ...
        <div style="width: 90%;height: 40px;margin: 0 auto;">
            <input type="text" required placeholder="First name" value="" name="firstname" id="firstname"
        ...
        <div style="width: 100%;height: 15px;"></div>
        <div style="width: 90%;height: 40px;margin: 0 auto;">
            <input type="email" required placeholder="Email" name="mail" id="mail"
                   style="width: 90%;height: 40px;margin: 0 auto; border: 1px solid #C0C0C0;border-radius: 3px;font-size: 16px;font-family: arial;font-weight: 500; padding-left: 12px;"/>
        </div>
        <div style="width: 100%;height: 15px;"></div>
        <div style="width: 90%;height: 40px;margin: 0 auto;">
            <input type="password" required placeholder="Create a password" name="Epwd" id="Epwd"
                   style="width: 90%;height: 40px;margin: 0 auto; border: 1px solid #C0C0C0;border-radius: 3px;font-size: 16px;font-family: arial;font-weight: 500; padding-left: 12px;"/>
        </div>
        <div style="width: 100%;height: 15px;"></div>
        <div style="width: 90%;height: 40px;margin: 0 auto;">
            <input type="password" required placeholder="Confirm password" name="ReEpwd" id="ReEpwd"
                   style="width: 90%;height: 40px;margin: 0 auto; border: 1px solid #C0C0C0;border-radius: 3px;font-size: 16px;font-family: arial;font-weight: 500; padding-left: 12px;"/>
        </div>
        <div style="width: 100%;height: 15px;"></div>
        ...
        <div style="width: 90%;height: auto;color: #666666;margin: 0 auto;">
            <input type="checkbox" name="checkbox" id="checkbox" value="checkbox" style="width:17px;height:auto">I have
