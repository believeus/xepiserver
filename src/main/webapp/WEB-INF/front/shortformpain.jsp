	...
	<div id="container" style="width: 100%;height: 100%;background-color: #DEDEDE;">
			...
			<div style="width: 100%;height: auto;">
				...
				<div style="accelerator: 100%;height: auto;background-color: #C1272D;">
					<div style="width: 90%;height: auto;margin: 0 auto;color: #FFFFFF; font-family: arial;font-size: 14px;">
						Introduction: The Mcgill Pain Questionnaire(MPQ)(] has become one of the most wideused tests for the measurement of pain. 
				It provides valuable information on thesensory, affective and evaluative dimensions of pain experience and is capablediscriminating among differentproblems [7].
				 The MPQ is not a perfect tooland several variants have been developed [2, 4,7]. Yet despite the usefulness ofspecialized alternative forms, 
				the original MPQ is still commonly used in diagnosisand research on a wide variety of pain problems [7]
					</div>
				</div>
			</div>
		</div>
		<div id="content" style="width: 100%;height: auto;background-color: #DEDEDE">
			...
			<div class="ques1" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				...
				<div style="width: 96%;height: auto;font-size: 16px;margin:0 auto; font-family: airal;font-weight: 600; color: #666666;">1.Throbbing?</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex1-bar" type="text" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
				</div>
				<div style="width: 100%;height: auto;">
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div><span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">mild (level1)</span>&nbsp;<span style="color: #FFC000;">moderate  (level 2)</span></div>
			...
			<div class="ques2" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">2.shooting</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					<div style="width: 100%;height: 10px;"></div>
				...
				<div style="width: 100%;height: auto;">
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div><span style="color: #92D050;">none(level 0)</span>&nbsp; &nbsp;<span style="color: #92D050;">mild (level 1)</span></div>
						<div><span style="color: #FFC000;">moderate (level 2)</span>&nbsp; &nbsp;<span style="color: red;">severe (level 3)</span></div>
					</div>
			...
			<div class="ques3" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">3. Stabbing</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pian-ex3-bar" type="text" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div>
							<span style="color: #92D050;">none(level 0)</span>&nbsp;&nbsp; <span style="color: #92D050;">mild (level 1)</span>&nbsp;&nbsp;<span style="color: #FFC000;">moderate (level 2)</span>
						</div>
						<div>
			...
			<div class="ques4" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;font-weight: 600;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;padding: 10px;">4. Sharp</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div class="ques5" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">5. Cramping</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex5-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div>
							<span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">mild (level1)</span>&nbsp;<span style="color: #FFC000;">modereate  (level 2)</span>
						</div>
						<div>
							<span style="color: #FFC000;">severe (level 3)</span>
						</div>
			...
			<div class="ques6" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">6. Gnawing</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div class="ques7" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">7. Hot-burning</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex7-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
			...
			<div class="ques8" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">8. Aching</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex8-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
			...
			<div class="ques9" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">9. Heavy</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex9-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
					<div class="pain-ex9-barCurrentSliderValLabel" style="font-size: 16px;font-family: arial;"></div>
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div>
							<span style="color: #92D050;">none(level 0)</span>&nbsp;&nbsp; <span style="color: #92D050;">mild (level1)</span>&nbsp;&nbsp;<span style="color: #FFC000;">moderate (level 3)</span>
						</div>
						<div>
			...
			<div class="ques10" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">10. Tender</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex10-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
					<div class="pain-ex10-barCurrentSliderValLabel" style="font-size: 16px;font-family: arial;"></div>
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div>
							<span style="color: #92D050;">none(level 0)</span>&nbsp;&nbsp; <span style="color: #92D050;">mild (level1)</span>&nbsp;&nbsp;<span style="color: #FFC000;">moderate (level 2)</span>
						</div>
						<div>
			...
			<div class="ques11" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">11. Splitting</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div class="ques12" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">12. Tiring-exhausting</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex12-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
			...
			<div class="ques13" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;padding: 10px;">13. Sickening</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
			...
			<div class="ques14" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;">14. Fearful</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex14-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
			...
			<div class="ques15" style="width: 96%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;padding: 10px;">
				<div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;font-weight: 600;">15. Pushing-curel</div>
				<div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
					...
					<div>
						<input class="pain-ex15-bar" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)" type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
					</div>
					<div class="pain-ex15-barCurrentSliderValLabel" style="font-size: 16px;font-family: arial;"></div>
					<div style="margin: 0 auto;text-align: center;width: 95%;text-align: center;">
						<div>
							<span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">mild (level1)</span>&nbsp;<span style="color:red;">moderate (level 2)</span>
						</div>
							<div>
							<span style="color: #FFC000;">severe (level 3)</span>
						</div>
