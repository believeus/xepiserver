...
<div style="height: 30px;width: 100%;clear: both;"></div>
		...
		<div id="bio" style="width: 100%;height: auto; background-color: #F0F0F0;position: relative;">
			...
			<div class="bio-title" style="width: 100%;height:60px ;">
				<div style="width: 57%;height: auto;float: left; line-height: 27px;font-size: large; font-weight: 700; font-family: arial;">Biological Age Detection by DNA Methylation</div>
		...
		<div id="sam-e" style="width: 100%;height: 800px;">
			...
			<div id="sam-e-con" style="width: 100%;height: auto;font-size: 12px; ">
				<div style="width: 96%;height: auto;margin: 0 auto; font-family: arial;color: #666666;">
					...
					<div style="width: 100%;height: 20px;"></div>
					<div id="blue-dot">The level of SAM-e decreases as the body ages. Concomitantly, a number of health issues, including mood, joint, and liver disorders might occur</div>
					<div style="width: 100%;height: 20px;"></div>
					<div id="blue-dot">SAM-e molecules have two chemical forms: the SS (active) isomer and the RS (inactive) isomer.</div>
					<div style="width: 100%;height: 20px;"></div>
