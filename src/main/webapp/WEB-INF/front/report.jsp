...
<div style="width: 100%;height: 100%;background-color: white;">
    ...
    <div style="width: 100%;height: 1550px;">
        ...
        <div style="width: 100%;height: auto;">
            <div style="width: 70%;height: auto;margin: 0 auto;font-size: 60px;font-weight: bold;color: #808080">This
                report provides you with the results of your "epigenetic age" test as well as a summary of your life
                style parameters.
            </div>
        </div>
    </div>
    <div style="width: 100%;height: 1550px">
        ...
        <div style="width: 100%;height: auto;font-size: 24px;">
            <div name='subc' style="width: 70%;margin: 0 auto;">People age at different rates. Some "look" and "feel"
                older than their chronological ages while other look younger than their chronological ages.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Our biological ages are better parameters of our health
                well being and life span than our chronological ages.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">If we think about our cells as minicomputers, we can
                look at DNA as the hard ware, genetics as the operating system and DNA methylation and other epigenetic
                factors as the software that programs the genome.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">A paradigm shift in the search for biological age
                markers occurred with the discovery of the “epigenetic clock” by Horvath, which is based on measurement
                of DNA methylation status at hundreds of strategic positions in DNA. This “epigenetic clock” is a
                measure of our biological ages.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">However in some people the “epigenetic age” is different
                from the “chronological age”. Sometimes the “epigenetic clock” moves faster than the “chronological
                clock”. We consider a difference that is larger than the standard deviation (or the normal distribution
                in the population) as a significant change.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">
                Studies suggest that accelerated “epigenetic clock” might be associated with increased risks for several
                age-related chronic diseases such as cardiovascular disease and cancer.<i
                    style="text-decoration: underline;">
                (https://www.ncbi.nlm.nih.gov/pubmed/?term=epigenetic+clock+disease)</i> This is however still an open
    ...
    <div style="width: 100%;height: 1500px">
        ...
        <div style="width: 100%;height: auto;font-size: 24px;">
            <div name='subc' style="width: 70%;margin: 0 auto;">After extensive data mining, we have discovered a single
                age-related CG methylation region that was sufficient to accurately predict biological age using saliva.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">We prepare DNA from your saliva and then measure the
                level of DNA methylation in several positions in a fragment of your genome using next generation
                sequencing and bisulfite mapping. Your states of DNA methylation are inserted into a mathematical
                equation that calculates the “epigenetic age” as a function of the level of DNA methylation.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">We consider it as a “red flag” when your “epigenetic
                age” deviates from your “chronological age” by one standard deviation. Standard deviation provides an
                idea about the distribution of difference from the mean in the normal population, which at this point of
                analysis is around 5 years. At this stage, if your “epigenetic age” is 5 years older than your
                “chronological age” you might consider the result as a “red flag”. As more tests are accumulated we will
                get a more accurate value of the “normal distribution”.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Although it is still not clear how one can decelerate
                his “epigenetic clock”, lifestyle changes recommended by most national medical associations are perhaps
                a starting point. An older “epigenetic age” is a “red flag” which hints that it is time to make some
                lifestyle changes.
            </div>
            <div name='subc' style="width: 70%;margin: 0 auto;">A “red flag” might prompt you to act on your lifestyle
                or consult your physician for a check up.
            </div>
        </div>
    </div>
    ...
    <div style="width: 100%;height: 1500px">
        ...
        <div style="width: 100%;height: auto;">
            <div style="width: 70%;height: auto;margin: 0 auto;font-size: 40px;font-weight: bold;color: #00b0f0;">What
                can I do if my “epigenetic age” is older?
            </div>
        </div>
        <div style="width: 70%;margin: 0 auto;"></div>
        <div style="width: 100%;height: auto;font-size: 24px;">
            <div name='subc' style="width: 70%;margin: 0 auto;">“Epigenetics” is different from “genetics” in a
                substantial way that epigenetics is potentially reversible by dietary interventions and life style
                changes. So, it might be possible to reverse the “epigenetic clock”.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Preliminary studies show that dietary changes can cause
                deceleration of epigenetic clock in certain people, however this is still an open question. (
                https://www.ncbi.nlm.nih.gov/pubmed/30350398)
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Lifestyle changes including exercise and dietary habits
                have been recommended by national medical associations for some time, however, we need more data about
                the most advisable changes and they should be personalized.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">A way for us to learn about advisable lifestyle changes
                is sharing our experiences with others and analyzing the impact of differences in lifestyle in a large
                population. This is now possible using sharing technologies such as Apps as well as artificial
                intelligence that could determine how different inputs such as “lifestyle” habits affect an outcome--the
                “epigenetic clock”.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Our App links you to information on recommended
                lifestyle behaviors by important US national medical association as well as possible nutritional
                supplements such as SAMe, vitamin A, D and C.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">These links are updated regularly and we suggest that
                you keep updating by examining the links periodically. These recommendations are based on what “science”
                knows today, they are not perfect. With more data and more analysis science is improving.
            </div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Our first report is based on the lifestyle data that you
                have entered which shows how far your lifestyle parameters deviate from consensus recommendations. You
                might decide to make changes based on this first report.
            </div>
        </div>
    </div>
    ...
    <div style="width: 100%;height: 1500px">
        ...
        <div style="width: 100%;height: auto;">
            <div style="width: 70%;height: auto;margin: 0 auto;font-size: 40px;font-weight: bold;color: #00b0f0;">A
                dynamic long-term partnership to achieve “healthy aging”
            </div>
        </div>
        <div style="width: 100%;height: 30px;"></div>
        <div style="width: 100%;height: auto;font-size: 24px;">
            <div name='subc' style="width: 70%;margin: 0 auto;">We suggest that you keep entering your life style
                data.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">You will update your life style data as regularly as you
                wish. You might update all questions, some or none. However, we believe that accurate reporting will
                allow us to provide you with a better analysis.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Your data will be anonymized. Your data and data from
                many other anonymous users will be analyzed by artificial intelligence to develop a “model”, which
                measures the impact of life style changes on “epigenetic clock”.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Once more data is accumulated, the “model” will examine
                your life style data and results of the test will be shared with you.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">We suggest that in 6 months or maximally a year you
                submit your saliva to a second test.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">We will analyze your “epigenetic age” and report on the
                progress and the lifestyle changes that you have made.
            </div>
            <div style="width: 70%;height: 20px;"></div>
            <div name='subc' style="width: 70%;margin: 0 auto;">Possible routes for change will be offered based on our
                “model” and your data.
            </div>
            <div name='subc' style="width: 70%;margin: 0 auto;">
                We hope that together we will be able to coevolve your well being and our “<i>epi</i>Aging” learning
                environment.
            </div>
        </div>
    </div>
    ...
    <div style="width: 100%;height: 1450px;">
        ...
        <div style="width: 70%;height: auto;margin:0 auto;text-align: center;">
            <div style="width: 100%;height: 40px;border-top: 1px solid #5b9bd5;">
                <div style="float: left;font-weight: bold;font-size: 18px;width: 50%;height: 40px;line-height: 40px;">
                    Your chronological age
                </div>
                <div style="float: left;width: 50%;height: 40px;font-weight: bold;line-height: 40px;"
                     id="chroage"></div>
            </div>
            <div style="background-color:#DEEBF7;width: 100%;height: 40px;;border-top: 1px solid #5b9bd5;;border-bottom: 1px solid #5b9bd5;">
                <div style="float: left;width: 50%;line-height: 40px;height: 40px;font-weight: bold;font-size: 18px;">
                    Your biological age
                </div>
                <div style="float: left; line-height: 40px;width: 50%;height: 40px;color: red;font-weight: bold;"
                     id="bioage"></div>
            </div>
        </div>
        <div style="width: 900px;height: 600px;position: relative;">
            ...
            <div style="width: 100%;height: 20px;text-align: center;position: relative;top:-25px;font-weight: bold;left: 80px;">
    ...
    <div style="width: 100%;height:auto;">
        <div style="width: 100%;height: auto;font-size: 40px;font-weight: bold;text-align: center;">Health & Lifestyle
        </div>
    </div>
    <div style="width: 100%;height: 100px;"></div>
    <script>
    ...
    <div class="weight" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex1SliderVal" style="font-size: 16px;font-family: arial;font-weight: bold; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div style="width: 100%;height: auto;">
                <input style-gradient="-webkit-linear-gradient(left, red 0%, #92D050 30%,#92D050 70%, red 100%)"
                       class="ex1" type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1"
                       data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 2%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
                    0
                </div>
    ...
    <div class="height" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div style="width: 100%;height: 20px; "></div>
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex2SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div style="width: 100%;height: auto;">
                <input class="ex2"
                       style-gradient="-webkit-linear-gradient(left, red 0%, #92D050 30%,#92D050 70%, red 100%)"
                       type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1" data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 2%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
                    0
    ...
    <div class="MBI" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex3SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div style="width: 100%;height: auto;">
                <input class="ex3"
                       style-gradient="-webkit-linear-gradient(left, red 0%, #92D050 25%,yellow 75%, red 100%)"
                       type="text" data-slider-min="0" data-slider-max="3" data-slider-step="1" data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 5%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
                    0
                </div>
    ...
    <div class="heartrate" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div style="width: 100%;height: 20px; "></div>
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex4SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div style="width: 100%;height: auto;">
                <input class="ex4" style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 90%,  red 100%)"
                       type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1" data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 5%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
    ...
    <div class="food" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            ...
            <div>
                <input class="ex5"
                       style-gradient="-webkit-linear-gradient(left, #92D050 0%,#FFF000 25% ,#FFC000 50%,  red 100%)"
                       type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1" data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 5%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
    ...
    <div class="heartrate" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div style="width: 100%;height: 20px; "></div>
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex7SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div style="width: 100%;height: auto;">
                <input class="ex7" style-gradient="-webkit-linear-gradient(left, #92D050 0%,#FFC000 50%,  red 100%)"
                       type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1" data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 5%;float: left;height: 100%;text-align: right;font-weight: bold;text-align: left;">
    ...
    <div class="vitaminA" style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;">
        ...
        <div style="width: 100%;height: 20px;"></div>
        <div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;">
            <strong> Recommendation: </strong> The recommended daily amount of vitamin A is 900 micrograms (mg) for
            adult men and 700 mg for adult women.
        </div>
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div style="width: 100%;height: 20px;"></div>
            <div class="ex10SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div>
                <input class="ex8"
    ...
    <div class="vitaminC" style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;">
        ...
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div style="width: 100%;height: 20px;"></div>
            <div class="ex9SliderVal" style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;">
                Please download App and fill in your data
            </div>
            <div>
                <input class="ex9"
    ...
    <div class="food" style="width: 70%;margin: 0 auto;height: auto;background-color: #FFFFFF;">
        ...
        <div class="scroll-bar" style="width: 90%;height: auto;margin: 0 auto;">
            <div class="ex11SliderVal"
                 style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;"></div>
            <div>
                <input id="food"
                       style-gradient="-webkit-linear-gradient(left, red 0%, #92D050 30%,#92D050 70%, red 100%)"
                       class="ex11" type="text" data-slider-min="0" data-slider-max="4" data-slider-step="1"
                       data-slider-value="0">
            </div>
            <div style="width: 100%;height: 20px;">
                <div style="width: 5%;float: left;height: 100%;text-align: left;font-weight: bold;">0</div>
    ...
    <div style="width: 100%;height: auto;">
        ...
        <div class="ques1"
             style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;border-radius: 10px;">
            ...
            <div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
                <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Last input
                    value
                </div>
                <div style="width: 100%;height: 20px;"></div>
                <div class="ex1SliderVal"
                     style="font-size: 16px;font-family: arial;line-height: 40px; font-weight: 700; margin: 0 auto;color: #C1272D;line-height: 40px"></div>
                <div style="width: 100%;height: 20px;">
                    ...
                    <div style="width:  17%;float: left;height: 100%;text-align: left;font-weight: bold;">
                        discomforting
                    </div>
                    <div style="width:  17%;float: left;height: 100%;text-align: left;font-weight: bold;">distressing
                    </div>
                    <div style="width:  15%;float: left;height: 100%;text-align: left;font-weight: bold;">horrible</div>
                    <div style="width:  15%;float: left;height: 100%;text-align: left;font-weight: bold;">excruciating
                    </div>
                    <div style="width:  5%;float: left;height: 100%;text-align: left;font-weight: bold;">pounding</div>
                </div>
                <div style="width: 100%;height: 5px;"></div>
                <div>
                    <input class="pain-ex1" type="text"
                           style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)"
                           data-slider-min="0" data-slider-max="6" data-slider-step="1" data-slider-value="0">
                </div>
                <div style="width: 100%;height: 20px;">
            ...
            <div style="width: 100%;height: auto;">
                <div style="margin: 0 auto;text-align: center;width: 95%;">
                    <div><span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">flickering(level 1)</span>
                    </div>
                    <div><span style="color: #FFC000;">quivering (level 2)</span>&nbsp; <span style="color: #FFC000;">pulsing(level 3)</span>&nbsp;<span
                            style="color: #FFC000;">throbbing(level 4)</div>
                    <div></span>&nbsp; <span style="color: red;">beating(level 5)</span>&nbsp; <span
                            style="color: red;">pounding(level 6)</span></div>
                </div>
                <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Weekly
                    data
                </div>
                <div>
        ...
        <div class="ques2" style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;">
            ...
            <div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
                ...
                <div style="width: 100%;height: 20px;"></div>
                <div class="ex2SliderVal"
                     style="font-size: 16px;font-family: arial;font-weight: 700; margin: 0 auto;color: #C1272D;line-height: 40px"></div>
                <div style="width: 100%;height: 20px;">
                    <div style="width: 25%;float: left;height: 100%;text-align: left;font-weight: bold;">none</div>
                    <div style="width:  15%;float: left;height: 100%;text-align: center;font-weight: bold;">jumping
                    </div>
                    <div style="width:  30%;float: left;height: 100%;text-align: right;font-weight: bold;">flashing
                    </div>
                    <div style="width:  30%;float: left;height: 100%;text-align: right;font-weight: bold;">shooting
                    </div>
                </div>
                <div style="width: 100%;height: 5px;"></div>
                <div>
                    <input class="pain-ex2" type="text"
                           style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)"
            ...
            <div style="width: 100%;height: auto;">
                <div style="margin: 0 auto;text-align: center;width: 95%;">
                    <span style="color: #92D050;">none (0 level)</span>&nbsp; <span style="color: #92D050;">jumping(1 level)</span>&nbsp;
                    <span style="color: #FFC000;">flashing(2 level)</span>&nbsp; <span style="color: #FFC000;">shooting(3 level)</span>&nbsp;
                </div>
                <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Weekly
                    data
                </div>
        ...
        <div class="ques3" style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;">
            ...
            <div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
                ...
                <div style="width: 100%;height: 20px;">
                    ...
                    <div style="width:  10%;float: left;height: 100%;text-align: left;font-weight: bold;">lancinating
                    </div>
                </div>
                <div style="width: 100%;height: 5px;"></div>
                <div>
                    <input class="pain-ex3"
                           style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)"
                           type="text" data-slider-min="0" data-slider-max="5" data-slider-step="1"
                           data-slider-value="0">
                </div>
                <div style="width: 100%;height: 20px;">
            ...
            <div style="margin: 0 auto;text-align: center;width: 95%;">
                <div><span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">pricking(1 level)</span>
                </div>
                <div><span style="color: #FFC000;">boring(2 level)</span>&nbsp; <span style="color: #FFC000;">drilling(3 level)</span>&nbsp;<span
                        style="color: #FFC000;">throbbing(level 4)</div>
                <div></span>&nbsp; <span style="color: red;">stabbing(4 level)</span>&nbsp; <span style="color: red;">lancinating(5 level)</span>
                </div>
            </div>
            <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Weekly data
            </div>
            <div>
        ...
        <div class="ques4" style="width: 70%;height: auto;margin: 0 auto; background-color: #FFFFFF;font-weight: 600;">
            <div style="width: 100%;height: auto;font-size: 16px; font-family: airal;color: #666666;padding: 10px;">
                4.incisive pressure
            </div>
            <div class="scroll-bar" style="width: 96%;height: auto;margin: 0 auto;">
                <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Last input
                ...
                <div style="width: 100%;height: 20px;">
                    ...
                    <div style="width:  10%;float: left;height: 100%;text-align: right;font-weight: bold;">lacerating
                    </div>
                </div>
                <div>
                    <input class="pain-ex4"
                           style-gradient="-webkit-linear-gradient(left, #92D050 0%, #FFC000 60%,  red 100%)"
            ...
            <div style="margin: 0 auto;text-align: center;width: 95%;">
                <div><span style="color: #92D050;">none(level 0)</span>&nbsp; <span style="color: #92D050;">sharp(1 level)</span>
                </div>
                <div><span style="color: #FFC000;">cutting(2 level)</span>&nbsp; <span style="color: red;">lacerating(3 level)</span>
                </div>
            </div>
            <div style="width: 100%;height: 20px;text-align: center;font-weight: bold;font-size: 30px;">Weekly data
            </div>
