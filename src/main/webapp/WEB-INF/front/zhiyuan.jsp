                            ...
                            <div class="content-slide">
                                <div id="career">
                                    <div style="width: 90%;height: auto;margin: 0 auto;">
                                        ...
                                        <div>
                                            2015.05<strong> Trainee Abstract Award,</strong> The American Association
                                            Immunologists (AAI) Annual Meeting;
                                        </div>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <div>
                                            2010.09 <strong> National Scholarship,</strong>  China Scholarship Council;
                                        </div>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <div style="font-weight: 800;line-height: 22px;">Ad Hoc Reviewer for Journals
                                        </div>
                                        ...
                                        <div style="font-weight: 800;line-height: 40px;">Editorial Board of Journal
                                        </div>
                                        <div><i>Journal of Immunoassay and Immunochemistry</i></div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="content-slide">
                                <div style="width: 90%;height: auto;margin: 0 auto;line-height: 22px">
                                    <div style="width: 100%;height: 40px;"></div>
                                    <ul>
                                        <li>2015 Annual Meeting of the American Society of Immunologists (<i
                                                style="font-weight: 600;">New Orleans, USA</i>)
                                        </li>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <li>Third Annual Conference of the 2014 Southeast American Symposium on
                                            Immunology (<i style="font-weight: 600;">Atlanta, USA</i>)
                                        </li>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <li>2014 Georgia State University Biotechnology Seminar (<i
                                                style="font-weight: 600;">Atlanta, USA</i>)
                                        </li>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <li>2013 Georgia State University-Nanjing University Biotechnology Seminar (<i
                                                style="font-weight: 600;">Atlanta, USA</i>)
                                        </li>
                                        <div style="width: 100%;height: 20px;"></div>
                                        <li>Third Asia-Pacific Diabetes Symposium 2009 (<i style="font-weight: 600;">Nanjing,
                                            China</i>)
                                        </li>
                                    </ul>
                                </div>
